...
Plans:
- [ ] 34-01-PLAN.md — Backend: Schema v4 migration, Pydantic models, ComparisonService, REST API
- [ ] 34-02-PLAN.md — Frontend: ComparisonPage, ConvergenceOverlay, DeltaFieldViewer, MetricsTable, routes
...
| 34. PO-03 Cross-Case Comparison | 0/2 | Planned | — |
